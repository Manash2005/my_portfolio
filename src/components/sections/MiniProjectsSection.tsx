...
const { miniProjects: content } = data.pageContent;
...
export default function MiniProjectsSection() {
  return (
    <section id="mini-projects" className="bg-background-alt">
                ...
                <motion.div key={index} variants={itemVariants}>
                    ...
                    <CardFooter className="flex justify-end gap-2">
                        ...
                        <a href={project.githubUrl} target="_blank" rel="noopener noreferrer">
                            <Github className="mr-2 h-4 w-4" /> {data.pageContent.projects.buttons.github}
                        </a>
                        </Button>
                        {project.liveUrl && (
